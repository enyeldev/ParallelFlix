...
public class RecomendadorColaborativoTests
{
    ...
    private PerfilUsuario CrearUsuarioPrueba()
    {
        ...
        // Agregar IDs de películas vistas
        usuario.IdsVistos.Add(1);
        usuario.IdsVistos.Add(2);
    ...
    public async Task RecomendarAsync_RetornaKRecomendaciones_SinRepetidos()
    {
        ...
        var recomendador = new RecomendadorColaborativo();
